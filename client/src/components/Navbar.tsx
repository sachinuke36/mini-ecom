...
export default function Navbar({active, setActive}: Props) {
  ...
  return (
            <div className="w-full border border-fuchsia-900  lg:w-4/10 h-15 rounded-3xl mx-auto my-5 shadow-purple-500 shadow-lg flex justify-center items-center gap-2 md:gap-10 bg-white">
